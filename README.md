...
**Machine Parameters:**
- `temperatura_horno_c`: Oven temperature (°C) - Normal(220, 15)
- `presion_moldeado_bar`: Molding pressure (bar) - Normal(150, 20)
- `velocidad_linea_mpm`: Line speed (meters/min) - Normal(45, 5)
- `humedad_ambiente_pct`: Ambient humidity (%) - Normal(45, 10)

**Material Parameters:**
- `espesor_material_mm`: Material thickness (mm) - Normal(2.5, 0.3)
- `resistencia_material_mpa`: Material strength (MPa) - Normal(350, 40)

**Operational Parameters:**
- `tiempo_ciclo_seg`: Cycle time (seconds) - Normal(12, 2)
- `vibracion_maquina_hz`: Machine vibration (Hz) - Uniform(0.5, 3.5)
- `edad_herramienta_horas`: Tool age (hours) - Uniform(0, 500)

**Context:**
- `turno`: Shift (1=Morning, 2=Afternoon, 3=Night)
- `operador_experiencia_anos`: Operator experience (years) - Uniform(1, 20)
- `mantenimiento_dias_desde`: Days since last maintenance - Uniform(1, 30)
